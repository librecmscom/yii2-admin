    ...
    public static function radioListSmart($name, $selection = null, $items = [], $options = [])
    {
        ...
        foreach ($items as $value => $label) {
            ...
            if ($formatter !== null) {
                ...
                $lines[] = static::radioSmart($name, $checked, array_merge($itemOptions, ['value' => $value, 'label' => $encode ? static::encode($label) : $label]));
            }
            $index++;
        }
    ...
    public static function checkboxListSmart($name, $selection = null, $items = [], $options = [])
    {
        ...
        foreach ($items as $value => $label) {
            ...
            if ($formatter !== null) {
                ...
                $lines[] = static::checkboxSmart($name, $checked, array_merge($itemOptions, ['value' => $value, 'label' => $encode ? static::encode($label) : $label]));
            }
            $index++;
        }
        if (isset($options['unselect'])) {
