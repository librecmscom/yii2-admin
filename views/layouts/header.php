...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="<?= $asset->baseUrl; ?>/img/logo.png"> </span>
        ...
        <ul class="header-dropdown-list hidden-xs">
            <li>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?= $asset->baseUrl; ?>/img/blank.gif" class="flag flag-us" alt="United States"> <span> English (US) </span>
                    <i class="fa fa-angle-down"></i> </a>

                <ul class="dropdown-menu pull-right">
                    <li<?=Yii::$app->language == 'en-US'?' class="active"':''?>>
                        <a href="javascript:void(0);">
                            <img src="<?= $asset->baseUrl; ?>/img/blank.gif" class="flag flag-us" alt="United States">English (US)</a>
                    </li>

                    <li <?=Yii::$app->language == 'zh-CN'?' class="active"':''?>>
                        <a href="javascript:void(0);"><img src="<?= $asset->baseUrl; ?>/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
                    </li>
                </ul>
            </li>
        </ul>
