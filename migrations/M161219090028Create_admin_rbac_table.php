...
class M161219090028Create_admin_rbac_table extends Migration
{
    public function up()
    {
        ...
        //添加规则
        $this->insert('{{%admin_auth_rule}}', ['name' => 'RouteRule', 'data' => 'O:28:"backend\components\RouteRule":3:{s:4:"name";s:9:"RouteRule";s:9:"createdAt";i:1470972120;s:9:"updatedAt";i:1470972120;}', 'created_at' => time(), 'updated_at' => time()]);
        $this->insert('{{%admin_auth_rule}}', ['name' => 'GuestRule', 'data' => 'O:28:"backend\components\GuestRule":3:{s:4:"name";s:9:"GuestRule";s:9:"createdAt";i:1470972196;s:9:"updatedAt";i:1470972196;}', 'created_at' => time(), 'updated_at' => time()]);
